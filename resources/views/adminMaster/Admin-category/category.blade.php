                    ...
                    <div class="card-body">
                        <form action="#">
                            <div class="form-group">
                                <label class="control-label" for="fname">Category name</label>
                                <div class="mb-2">
                ...
                <div class="card card-statistics">
                    ...
                    <div class="card-body">
                        <form action="#">
                            ...
                            <div class="form-group">
                                <label class="control-label" for="fname">Category name to edit</label>
                                <div class="mb-2">
        ...
        function getData() {
                ...
                success: function ($data) {
                    ...
                    data.forEach((x) => {
                        ...
                        _html += '<a href="#"class="btn-edit mr-2" data-id='+ x.id +'>';
                        ...
                        _html += '</a>';
                        _html += '<a href="#"  class="delete"  data-id='+ x.id +' >';
