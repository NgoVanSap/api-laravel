                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="bg-img mr-4">
                                        <img src="{{ URL::to('assets/img/avtar/01.jpg') }}" class="img-fluid" alt="Clients-01">
                                    </div>
...
<script>
    $(document).ready(function(){
            ...
            $.ajax({
                ...
                success: function(res) {
                    if(res.status == true) {
                        ...
                        toastr.success('Update Member thành công');
                    }
                }
        ...
        $(".toartsErrorEditMember").click(function () {
            toastr.error('Bạn không có quyền Edit Member');
        });

        $(".toartsErrorDeleteMember").click(function () {
            toastr.error('Bạn không có quyền Xóa Member');
        });
    });
